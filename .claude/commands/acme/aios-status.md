...
- Antes de `/acme:implement --via aios` para verificar pré-requisitos
...
| Versão | Data | Mudança |
|---|---|---|
| 0.1.0 | 2026-05-06 | Versão inicial — Forge-6 AIOS status |
