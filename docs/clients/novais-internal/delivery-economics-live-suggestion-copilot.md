...
last_recalc_trigger: "manual — /novais-digital:unit-economics"
version: "0.1.0"
...
| **Baseline custo humano closer** | **TBD** — entrevistar RH Novais Digital (custo-hora, headcount, tempo/call) |
...
`R$ 0` para cliente interno Novais Digital. Clientes externos futuros: R$ 8.000–15.000 (onboarding + SHADOW 14 dias + corpus customizado).
...
## 6. Projeção mensal por cliente (5 closers — Novais Digital interno)
...
Hook responsável: `unit-economics-recalc` (Foundry-4 — ainda não implementado no consumer).
...
**Status**: `viable` com `data_confidence: low` no baseline humano. C3 passa. Autorizado a prosseguir para `/novais-digital:sla-threshold`.
...
|---|---|---|---|
| 0.1.0 | 2026-05-20 | Versão inicial — custo medido na POC | manual /novais-digital:unit-economics |
