...
target_client: "novais-digital-internal"
status: "retroactive"
fee_brl: 0
delivery_days: 0
...
owners:
  consultant: "Rafael Novaes (Novais Digital)"
  technical_reviewer: "(pendente)"
created_at: "2026-05-19"
delivered_at: "2026-05-19"
version: "0.1.0"
foundry_skill_version: "diagnostic-runner@v0.2.0"
foundry_command_version: "diagnose@v0.2.0"
...
retroactive_note: |
  ...
  seniores Novais Digital antes da promoção SHADOW.
  trace_id ausente porque Langfuse ainda não está integrado (débito C6
  declarado em docs/foundry/manifest.json).
---

# Diagnostic — live-suggestion-copilot (Novais Digital Internal)

> **Status:** retroativo. Construído após o MVP técnico para cumprir C1
> formalmente. Gaps de baseline declarados explicitamente.
> **Cliente:** Novais Digital (interno — closers próprios)
> **Módulo alvo:** `live-suggestion-copilot` (declarado em docs/foundry/project.json)
...
> "Closers Novais Digital perdem oportunidades por: pular etapas do diagnóstico (SPIN),
...
|---|---|---|
| Custo de uma hora-closer (salário + encargos) | TBD R$/h | RH Novais Digital |
...
| Critério ICP Novais Digital | Resultado |
|---|---|
| PME R$2M+ com CEO bombeiro | Novais Digital é a própria empresa — fit por construção |
...
- **SKU existente?** Não. Este é um agente novo no catálogo Novais Digital.
- **Variante de SKU existente?** Não.
- **Novo SKU?** Sim. Nome proposto: `live-suggestion-copilot`.

**Resultado:** `new` — criar SKU vertical novo via `/novais-digital:spec --type=platform-sku`.
...
- [ ] Entrevistar 2-3 closers seniores Novais Digital (60min cada) — preencher
...
- [ ] Rodar `/novais-digital:spec --type=platform-sku --client_id=novais-digital-internal
      --artifact_id=live-suggestion-copilot`.
- [ ] Rodar `/novais-digital:unit-economics --artifact_id=live-suggestion-copilot`.
- [ ] Definir `/novais-digital:sla-threshold` formal (já temos os números deste
...
```
/novais-digital:spec --type=platform-sku --client_id=novais-digital-internal \
             --artifact_id=live-suggestion-copilot
```

---

## Verification gate (do command /novais-digital:diagnose)
...
- [x] Arquivo persistido em `docs/clients/novais-digital-internal/`
...
artifact_path: docs/clients/novais-digital-internal/diagnostic-live-suggestion-copilot.md
project_type: agentic_saas
ai_enabled: true
...
baseline_handoff:
  ...
  ready_for: "/novais-digital:spec --type=platform-sku --client_id=novais-digital-internal --artifact_id=live-suggestion-copilot"
  fields_collected:
  ...
  fields_missing:
    - "closer_hourly_cost_brl (RH Novais Digital)"
...
next_step: "/novais-digital:spec --type=platform-sku --client_id=novais-digital-internal --artifact_id=live-suggestion-copilot"
```
